...
assert.equal(jsonLd.url, "https://quanto-em-taxas.dlt.academy/");
...
const sandbox = {
  ...
  window: { location: { search: "?c=yt&v=taxas_2026" } },
...
assert.equal(tracking.getVariant(), "taxas_2026");
...
console.log("Technical contract: OK — metadata, cost scope, market choice, links and tracking");
